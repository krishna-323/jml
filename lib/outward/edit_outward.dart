...
class _EditOutwardState extends State<EditOutward> {
  ...
  void initState() {
    ...
    entryDateController.text = widget.outwardList['entryDate']??"";
    entryTimeController.text = widget.outwardList['entryTime']??"";
    vehicleNoController.text = widget.outwardList['vehicleNo']??"";
    ...
    invoiceDateController.text = widget.outwardList['invoiceDate']??"";
    invoiceDCTypeController.text = widget.outwardList['invoiceType']??"";
    enteredByController.text = widget.outwardList['entredBy']??"";
